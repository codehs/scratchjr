...
{
	if (region.aF.am === region.aP.am)
	{
		return 'on line ' + region.aF.am;
	}
	return 'on lines ' + region.aF.am + ' through ' + region.aP.am;
}
	...
	function (command, componentBuilder) {
		...
		var newSegment = function () {
			switch (commandType.$) {
				...
				case 4:
					var startControl = commandType.a.n;
					...
					return $author$project$Path$CubicCurveSegment(
						{
							h: absolute(endControl),
							b: currentPoint,
							n: A2($author$project$Point$reflectOver, currentPoint, previousControl),
							a: absolute(to)
						});
				case 6:
				...
				case 8:
					...
					var size = commandType.a.u;
					var rotation = commandType.a.t;
					var to = commandType.a.a;
		...
		var newComponent = {s: command, E: newSegment};
		...
		return {
			y: A2($elm$core$List$cons, newComponent, components),
			at: nextCurrentPoint,
...
var $author$project$Path$initComponentBuilder = {y: _List_Nil, at: $author$project$Point$zero, au: $author$project$Point$zero};
var $elm$core$List$reverse = function (list) {
	return A3($elm$core$List$foldl, $elm$core$List$cons, _List_Nil, list);
};
var $author$project$Path$buildComponents = function (commands) {
	return $elm$core$List$reverse(
		A3($elm$core$List$foldl, $author$project$Path$buildComponent, $author$project$Path$initComponentBuilder, commands).y);
};
...
var $author$project$Path$Parser$FormattedArc = F5(
	function (radii, angle, size, rotation, to) {
		return {q: angle, r: radii, t: rotation, u: size, a: to};
	});
...
var $author$project$Path$Parser$FormattedArcRotation = F2(
	function (rotation, afterRotation) {
		return {ay: afterRotation, t: rotation};
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{aN: col, l: s0.l, p: s0.p, O: offset, bb: row, d: s0.d});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.O, s.bb, s.aN, s);
	};
};
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {aN: col, br: contextStack, a3: problem, bb: row};
	});
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.bb, s.aN, x, s.l));
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.O, s.bb, s.aN, s.d);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{aN: newCol, l: s.l, p: s.p, O: newOffset, bb: newRow, d: s.d});
	};
};
								...
								F4(
									function (before1, after1, before2, after2) {
										return $author$project$Path$Comma(
											{bJ: after2 - before2, bK: after1 - before1});
									})),
...
var $elm$parser$Parser$Advanced$bumpOffset = F2(
	function (newOffset, s) {
		return {aN: s.aN + (newOffset - s.O), l: s.l, p: s.p, O: newOffset, bb: s.bb, d: s.d};
	});
	...
	function (invalid, expecting, intSettings, floatSettings, intPair, s) {
		...
		if (floatOffset < 0) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				true,
				A4($elm$parser$Parser$Advanced$fromInfo, s.bb, s.aN - (floatOffset + s.O), invalid, s.l));
		} else {
		...
		return $elm$parser$Parser$Advanced$number(
			{
				...
				aY: $elm$core$Result$Ok($elm$core$Basics$toFloat),
				by: invalid,
...
var $author$project$Path$Parser$FormattedPoint = F4(
	function (x, afterX, y, afterY) {
		return {aJ: afterX, aK: afterY, e: x, f: y};
	});
	...
	function (sep, _v0) {
		...
		return A2(
			$author$project$Path$ArcCommand,
			{
				...
				t: $author$project$Path$Parser$getArcRotation(rotation),
				u: $author$project$Path$Parser$getArcSize(size),
	...
	function (isGood, expecting) {
		return function (s) {
			...
			return _Utils_eq(newOffset, -1) ? A2(
				...
				true,
				0,
				{aN: 1, l: s.l, p: s.p, O: s.O + 1, bb: s.bb + 1, d: s.d}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{aN: s.aN + 1, l: s.l, p: s.p, O: newOffset, bb: s.bb, d: s.d}));
		};
	});
...
var $author$project$Path$Parser$closeCommand = function (builder) {
	...
	return A2(
		...
		function (newResult) {
			return {
				D: A2($elm$core$List$cons, newResult, builder.D),
...
var $author$project$Path$Parser$FormattedCubicCurve = F3(
	function (startControl, endControl, to) {
		return {h: endControl, n: startControl, a: to};
	});
	...
	function (sep, _v0) {
		...
		return A2(
			$author$project$Path$CubicCurveCommand,
			{
				...
				n: $author$project$Path$Parser$getPoint(startControl),
				a: $author$project$Path$Parser$getPoint(to)
			},
			{
...
var $author$project$Path$fromComponents = function (components) {
	return {y: components, aA: $elm$core$Maybe$Nothing, z: _List_Nil};
};
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {aN: col, a3: problem, bb: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.bb, p.aN, p.a3);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{aN: 1, l: _List_Nil, p: 1, O: 0, bb: 1, d: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $author$project$Path$segmentToAbsoluteExplicitCommand = function (segment) {
	switch (segment.$) {
		...
		case 4:
			...
			var size = segment.a.u;
			var rotation = segment.a.t;
			var to = segment.a.a;
			return $author$project$Path$preFormattedArc(
				{q: angle, r: radii, t: rotation, u: size, a: to});
		default:
...
var $author$project$Path$separatorToString = function (separator) {
	switch (separator.$) {
		...
		case 1:
			var spacesBefore = separator.a.bK;
			var spacesAfter = separator.a.bJ;
...
var $author$project$Clean$cleanCommandString = function (commandString) {
		...
		while (true) {
			if (fromIndex < 0) {
				return A2(
					...
					false,
					{x: nodeList, v: (len / $elm$core$Array$branchFactor) | 0, w: tail});
			} else {
...
var $author$project$Clean$output = _Platform_outgoingPort('output', $elm$json$Json$Encode$string);
var $author$project$Clean$init = function (commandString) {
	return _Utils_Tuple2(
		0,
		$author$project$Clean$output(
			$author$project$Clean$cleanCommandString(commandString)));
};
var $elm$json$Json$Decode$string = _Json_decodeString;
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Clean$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$none;
};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Clean$update = F2(
	function (_v0, _v1) {
		return _Utils_Tuple2(0, $elm$core$Platform$Cmd$none);
	});
var $elm$core$Platform$worker = _Platform_worker;
var $author$project$Clean$main = $elm$core$Platform$worker(
	{bx: $author$project$Clean$init, bL: $author$project$Clean$subscriptions, bN: $author$project$Clean$update});
_Platform_export({'Clean':{'init':$author$project$Clean$main($elm$json$Json$Decode$string)(0)}});}(this));