...
export default class Paint {
    ...
    static gestureStart(e) {
        ...
        if (skipmodes.indexOf(mode) > -1) {
            if (
                ...
                PaintAction.currentshape.parentNode
            ) {
                PaintAction.currentshape.parentNode.removeChild(
                    PaintAction.currentshape
                );
            }
        }
    ...
    static initSprite(ow, oh) {
        ...
        if (currentMd5) {
            ...
            var dh =
                ...
                (workspaceHeight + 10);
            var dw =
                root.parentNode.parentNode.offsetWidth / (workspaceWidth + 10);
            Paint.setZoomTo(Math.min(dw, dh));
            PaintUndo.record(true);
        }
    }
    ...
    */
    ...
    static createCharFromXML(str) {
        ...
        var dy =
            workspaceHeight < 384 ? Math.floor((384 - workspaceHeight) / 2) : 0;
